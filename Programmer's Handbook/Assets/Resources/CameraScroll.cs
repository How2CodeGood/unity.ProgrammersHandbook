...
public class CameraScroll : MonoBehaviour
{
    ...
    {
        // Set the vertical position of the layout group based on the offset
        Vector2 newAnchoredPosition = verticalLayoutGroup.anchoredPosition;
        newAnchoredPosition.y -= offset;
        verticalLayoutGroup.anchoredPosition = newAnchoredPosition;
    }
}
